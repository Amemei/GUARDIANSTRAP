=============================================================================
 ...
 ----------------------------------------------------------------------------
 Version
 1.6.1 20190420 ダメージが0だった場合の表記を「MISS」から「0」に変更
 1.6.0 20181111 プラグインの型指定機能に対応
                  ポップアップ効果音を消音できるスイッチを追加
 1.5.1 20171110 コピペミスによる誤記を修正
 1.5.0 20170423 ポップアップ時にキャラクターをフラッシュさせる機能を追加
 1.4.0 20170303 ピクチャより前面にポップアップできる設定を追加
                  回転がない場合でも拡大率を自由に変更できるよう修正
 1.3.0 20170123 スリップダメージのポップアップに対応
                  対応するフォロワーのポップアップを表示する機能を追加
 1.2.0 20161231 ポップアップの色調設定機能を追加
                  ポップアップの表示方法を詳細指定できる機能を追加
 1.1.1 20160915 最新の修正で自動ポップアップの設定が手動に影響していた問題を修正
 1.1.0 20160914 MPダメージ用に専用効果音を指定できる機能を追加
                  HP、MP、TP、増加、減少の条件で個別に出力可否を設定できる機能を追加
 1.0.3 20160910 VE_BasicModule.jsとの競合を解消
 1.0.2 20160417 ポップアップ無効化のプラグインコマンドが機能していなかった問題を修正
 1.0.1 20160410 HPの増減との連動で増やすと減らすが逆に解釈されていたのを修正
 1.0.0 20160409 初版
 ----------------------------------------------------------------------------
 [Blog]    httpstriacontane.blogspot.jp
 [Twitter] httpstwitter.comtriacontane
 [GitHub]  httpsgithub.comtriacontane
=============================================================================
  ...
  @param 効果音演奏
  @desc 状況に応じたシステム効果音を自動演奏します。(ONOFF)
  @default true
  @type boolean
  ...
  @param HP自動ポップアップ
  @desc HPの増減を自動ポップアップの対象にします。(ONOFF)
  @default true
  @type boolean
 
  @param MP自動ポップアップ
  @desc MPの増減を自動ポップアップの対象にします。(ONOFF)
  @default true
  @type boolean
 
  @param TP自動ポップアップ
  @desc TPの増減を自動ポップアップの対象にします。(ONOFF)
  @default true
  @type boolean
 
  @param 増加自動ポップアップ
  @desc パラメータの増加を自動ポップアップの対象にします。(ONOFF)
  @default true
  @type boolean
 
  @param 減少自動ポップアップ
  @desc パラメータの減少を自動ポップアップの対象にします。(ONOFF)
  @default true
  @type boolean
 
  @param MPダメージ音
  @desc MPダメージ時の効果音ファイル名を別途指定(audiose)します。何も指定しないとHPと同じになります。
  @default
